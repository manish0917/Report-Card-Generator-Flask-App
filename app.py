import sys
import os
from flask import Flask, render_template, Response, flash, request, redirect, url_for, send_from_directory, Markup,make_response
...
def test():
	...
	pdfrender= render_template('card.html',can_details=can_details,recorddetails=recorddetails,questions=questions,pics=pics,count=count,stu_score=stu_score,stu_per=stu_per,graphimg=checkname[0]+'.png')
